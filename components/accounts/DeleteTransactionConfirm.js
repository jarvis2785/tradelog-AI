...
export default function DeleteTransactionConfirm({ onCancel, onConfirm, deleting }) {
  return (
    <AnimatePresence>
      <motion.div
        key="backdrop"
      ...
      >
        ...
        >
          <div className="flex items-start gap-3 mb-5">
            ...
            <div>
              <h3 className="text-h3 text-text-primary">Delete this transaction?</h3>
              <p className="text-body text-text-secondary mt-1">This cannot be undone.</p>
            </div>
          </div>

          <div className="flex items-center gap-3">
            <button onClick={onCancel} disabled={deleting} className="btn-secondary flex-1 h-11">
              Cancel
            </button>
            <button
              onClick={onConfirm}
