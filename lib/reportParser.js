...
export function goalsHeaderForType(reportType) {
  if (reportType === "monthly") return "3 GOALS FOR NEXT MONTH";
  if (reportType === "overall") return "3 GOALS FOR ONGOING DEVELOPMENT";
  return "3 GOALS FOR NEXT WEEK";
}
